...
var setGlobalMiddleware = (exports.setGlobalMiddleware =
  function setGlobalMiddleware(app) {
    ...
    _passport2.default.deserializeUser(
      (function () {
        var _ref = (0, _asyncToGenerator3.default)(
          /*#__PURE__*/ _regenerator2.default.mark(function _callee(id, done) {
            var user;
    ...
    app.use(
      ...
      _swaggerUiExpress2.default.setup(_swagger2.default, {
        explorer: true,
      })
    );

    app.get("/failure", function (req, res) {
      return res.redirect(_development.devConfig.frontendURL + "/login");
    });
  });
